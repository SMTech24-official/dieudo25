...
type SignupData = {
  ...
  // Garage Service Provider fields
  password: string;
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                {errors.vehicleMakeModel && (
                  <p className="text-red-500">{errors.vehicleMakeModel.message}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.yearOfManufacture && (
                  <p className="text-red-500">{errors.yearOfManufacture.message}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.licensePlateNumber && (
                  <p className="text-red-500">{errors.licensePlateNumber.message}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.tireCondition && (
                  <p className="text-red-500">{errors.tireCondition.message}</p>
                )}
              </div>
          ...
          <TabsContent value="provider">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex items-center">
                <Checkbox {...register("timeSlotAvailability")} />
                <label className="ml-2 text-sm text-gray-600">
                  Accepts appointments outside of regular hours
                </label>
              </div>
              ...
              <div className="space-y-2">
                <Input
                  ...
                  {...register("dailyCapacity", { required: "Daily capacity is required" })}
                />
                {errors.dailyCapacity && (
                  <p className="text-red-500">{errors.dailyCapacity.message}</p>
                )}
              </div>
                ...
                <Select onValueChange={(service) => addService(service)}>
                  ...
                  <SelectContent>
                    <SelectGroup>
                      ...
                      <SelectItem value="Tire Ordering for the Customer">
                        Tire Ordering for the Customer
                      </SelectItem>
                      <SelectItem value="Servicing and Other Mechanical Services">
              ...
              <Button
                type="submit"
                className="w-full group gap-2 bg-secondary hover:bg-secondary/80 active:scale-95 transition-all duration-300 py-2 rounded text-white hover:text-white font-medium">
                Sign Up
              </Button>
            </form>
          </TabsContent>
