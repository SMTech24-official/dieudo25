        ...
        <ScrollArea className="h-screen">
            <div className="dashboard-containers">
                <DashBoardHeading
                    ...
                    subTitle='Manage Your Account Preferences and Settings Here'
                />
                <Tabs defaultValue="personal" className="w-full">
                    ...
                    <TabsContent value="personal">
                        <Card>
                            ...
                            <CardFooter>
                                <Button className="bg-secondary ml-auto hover:bg-secondary/80 active:scale-95 transition-all duration-300  py-2 rounded-md text-white group"
                                >Save Changes</Button>
                            </CardFooter>
                        </Card>
                    </TabsContent>
                    <TabsContent value="vehicles">
                        <Card>
                            ...
                            <CardFooter className="flex justify-between">
                                ...
                                <Button className="bg-secondary hover:bg-secondary/80 active:scale-95 transition-all duration-300  py-2 rounded-md text-white group"
                                >Save Changes</Button>
                            </CardFooter>
                        </Card>
                    </TabsContent>
                    <TabsContent value="notifications">
                        <Card>
                            ...
                            <CardFooter>
                             <Button className="bg-secondary hover:bg-secondary/80 active:scale-95 transition-all duration-300 ml-auto  py-2 rounded-md text-white group"
